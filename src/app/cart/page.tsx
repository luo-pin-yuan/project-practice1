...
const productService = {
  getProducts: (): Product[] => {
    return [
      { id: 1, name: "習近平", price: 100, quantity: 0 },
      { id: 2, name: "賴清德", price: 200, quantity: 0 },
      { id: 3, name: "馬英九", price: 300, quantity: 0 },
    ];
  },
};
  ...
  const generatePurchaseOrder = () => {
    ...
    products.forEach((product) => {
      if (product.quantity > 0) {
        content += `${product.name}\t${product.quantity}\t${product.price}\t${
